<template>
  <div
    class="relative min-h-screen flex isolate overflow-hidden bg-gray-900 py-24 items-center sm:py-32"
  >
    <video
      autoplay
      loop
    ...
    <div class="mx-auto z-20 w-full mt-8 px-6 lg:px-8">
  ...
  <section class="bg-white dark:bg-gray-900">
    ...
    >
      ...
      <div class="hidden px-10 lg:mt-0 lg:col-span-5 lg:flex">
        <img
  ...
  <section class="bg-white dark:bg-gray-900">
    <div
      class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12"
    >
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex px-10">
        <img
          src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/phone-mockup.png"
          alt="mockup"
        />
